...
//creating 2nd question
        ...
        builder3.setTitle("We Love Rome");
        builder3.setQuestion("Rome starts with…?");
        builder3.addAnswer("Rome starts with the letter 'A'.",false);
        builder3.addAnswer("Rome starts with the letter 'B'.",false);
        builder3.addAnswer("Rome starts with the letter 'C'.",false);
        builder3.addAnswer("Rome starts with the letter 'D'.",false);
        builder3.addAnswer("Rome starts with the letter 'R'.",true);
